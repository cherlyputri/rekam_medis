...
class Resep_model extends CI_Model
{
	...
	//fungsi untuk ngitung jumlah resep obat
	function jumlahresepobat()
	{
		$query = $this->db->get('resep'); //pertama bikin variabel query isinya buat ambil data dr tabel resep
		if ($query->num_rows() > 0) { //terus di cek jumlah baris di tabel resep lebih dr 0 apa tidak
			return $query->num_rows(); //kalo lebih dari 0, misalnya jumlah barisnya ada 2 soalnya ada 2 resep yg terdaftar nah angka 2 tadi dikembaliin buat ditampilin
		} else {
