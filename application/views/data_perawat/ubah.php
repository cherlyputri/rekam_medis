    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-body">
            	<?php foreach ($perawat as $u) { ?> 
				<form action="<?= base_url('data_perawat/update'); ?>" method="post">
				  <div class="form-group row">
				  	<input type="hidden" name="id_perawat" value="<?= $u->id_perawat;?>">
				  ...
				  <div class="form-group row">
				    <div class="col-sm-10">
				      <button type="submit" name="ubah" class="btn btn-primary">Ubah</button>
				       <a href="<?= base_url('data_perawat/index'); ?>" class="btn btn-success">Kembali</a>
				    </div>
				  </div>
				</form>
