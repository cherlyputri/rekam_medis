 		...
 		<div class="card-header py-3">
 			...
 			<form action="" method="post">
 				...
 				<div class="form-group row">
 					...
 					<div class="col-sm-10">
 						<textarea class="form-control" id="keluhan" name="keluhan" rows="3"><?= $pemeriksaan['keluhan']; ?></textarea>
 					</div>
 				</div>
 				...
 				<div class="form-group row">
 					...
 					<div class="col-sm-10">
 						<textarea class="form-control" id="diagnosa" name="diagnosa" rows="3"><?= $pemeriksaan['diagnosa']; ?></textarea>
 					</div>
 				</div>
 					...
 					<div class="row">
 						...
 						<div class="col-sm-10">
 							<div class="custom-control custom-radio custom-control-inline">
 								<input type="radio" id="KONSULTASI DOKTER" name="tindakan" class="custom-control-input" value="KONSULTASI DOKTER" <?php if ($pemeriksaan['tindakan'] == 'KONSULTASI DOKTER') {
																																						echo 'checked';
																																					} ?> />
 								<label class="custom-control-label" for="KONSULTASI DOKTER">KONSULTASI DOKTER</label>
 							</div>
 							<div class="custom-control custom-radio custom-control-inline">
 								<input type="radio" id="PEMERIKSAAN LAB" name="tindakan" class="custom-control-input" value="PEMERIKSAAN LAB" <?php if ($pemeriksaan['tindakan'] == 'PEMERIKSAAN LAB') {
																																					echo 'checked';
																																				} ?> />
