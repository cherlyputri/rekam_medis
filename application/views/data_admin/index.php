                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $u->aktif ?></td>
                      <td>
                        <a href="<?= base_url('data_admin/hapus/' . $u->id_admin) ?>" class="btn btn-danger " onclick="return confirm('Apakah anda yakin ingin menghapus data admin tersebut??');"><i class="fa fa-trash"></i>Hapus</a>
