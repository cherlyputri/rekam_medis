  						...
  						<form action="" method="post">
  							...
  							<div class="form-group">
  								<div class="row">
  									...
  									<div class="col-sm-10">
  										<div class="custom-control custom-radio custom-control-inline">
  											<input type="radio" id="Laki-Laki" name="jenkel" class="minimal" value="Laki-Laki" <?php if ($pasien['jenkel'] == 'Laki-Laki') {
																																		echo 'checked';
																																	} ?> />
  											<label class="custom-control-label" for="Laki-Laki">Laki-Laki</label>
  										</div>
  										<div class="custom-control custom-radio custom-control-inline">
  											<input type="radio" id="Perempuan" name="jenkel" class="minimal" value="Perempuan" <?php if ($pasien['jenkel'] == 'Perempuan') {
																																		echo 'checked';
																																	} ?> />
  								...
  								<div class="form-group row">
  									...
  									<div class="col-sm-10">
  										<div class="custom-control custom-radio custom-control-inline">
  											<input type="radio" id="umum" name="pengobatan" class="minimal" value="Umum" <?php if ($pasien['pengobatan'] == 'Umum') {
																																echo 'checked';
																															} ?> />
  											<label class="custom-control-label" for="umum">Umum</label>
  										</div>
  										<div class="custom-control custom-radio custom-control-inline">
  											<input type="radio" id="bpjs" name="pengobatan" class="minimal" value="BPJS" <?php if ($pasien['pengobatan'] == 'BPJS') {
																																echo 'checked';
																															} ?> />
