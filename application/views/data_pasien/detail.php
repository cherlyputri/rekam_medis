  					...
  					<form action="" method="">
  							...
  							<div class="row">
  								...
  								<div class="col-sm-10">
  									<div class="custom-control custom-radio custom-control-inline">
  										<input type="radio" id="laki" name="jenkel" class="custom-control-input" value="Laki-Laki" <?php if ($pasien['jenkel'] == 'Laki-Laki') {
																																			echo 'checked';
																																		} ?> />
  										<label class="custom-control-label" for="Laki-Laki">Laki-Laki</label>
  									</div>
  									<div class="custom-control custom-radio custom-control-inline">
  										<input type="radio" id="cewe" name="jenkel" class="custom-control-input" value="Perempuan" <?php if ($pasien['jenkel'] == 'Perempuan') {
																																			echo 'checked';
																																		} ?> />
  						...
  						<fieldset class="form-group">
  							<div class="row">
  								...
  								<div class="col-sm-10">
  									<div class="custom-control custom-radio custom-control-inline">
  										<input type="radio" id="umum" name="pengobatan" class="custom-control-input" value="Umum" <?php if ($pasien['pengobatan'] == 'Umum') {
																																		echo 'checked';
																																	} ?> />
  										<label class="custom-control-label" for="umum">Umum</label>
  									</div>
  									<div class="custom-control custom-radio custom-control-inline">
  										<input type="radio" id="bpjs" name="pengobatan" class="custom-control-input" value="BPJS" <?php if ($pasien['pengobatan'] == 'BPJS') {
																																		echo 'checked';
																																	} ?> />
